...
static AdrasteaI_ATHTTP_Event_Result_t requestState = {.state = -1};
static AdrasteaI_ATCommon_IP_Addr_t serverAddress = "http://httpbin.org/get";
static AdrasteaI_ATCommon_Auth_Username_t username = "";
static AdrasteaI_ATCommon_Auth_Password_t password = "";
...
void ATHTTPExample()
{
    ...
    ret = AdrasteaI_ATHTTP_ConfigureNodes(1, serverAddress, username, password);
    ...
    ret = AdrasteaI_ATHTTP_GET(1, serverAddress, AdrasteaI_ATHTTP_Header_Presence_Disable, NULL, 0);
