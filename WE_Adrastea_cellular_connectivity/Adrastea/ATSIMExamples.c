...
static AdrasteaI_ATSIM_PIN_t pin = "2912";
...
void ATSIMExample()
{
    ...
    ret = AdrasteaI_ATSIM_SetFacilityLock(AdrasteaI_ATSIM_Facility_SC, AdrasteaI_ATSIM_Lock_Mode_Lock, pin);
    ...
    ret = AdrasteaI_ATSIM_SetFacilityLock(AdrasteaI_ATSIM_Facility_SC, AdrasteaI_ATSIM_Lock_Mode_Unlock, pin);
